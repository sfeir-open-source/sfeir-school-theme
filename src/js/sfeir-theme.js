class SfeirTheme {
  ...
  _manageBackgrounds() {
    const map = {
      "first-slide.first-red": `${
        this.path
      }images/src/images/background_red.png`,
      "first-slide.first-pink": `${
        this.path
      }images/src/images/background_pink.png`,
      "first-slide": `${this.path}images/src/images/background_blue.png`,
      "school-presentation": `${
        this.path
      }images/src/images/background_shcool.png`,
      ...
      "sfeir-bg-white-1": `${
        this.path
      }images/src/images/background_white_1.png`,
      "sfeir-bg-white-2": `${
        this.path
      }images/src/images/background_white_2.png`,
      "sfeir-bg-white-3": `${
        this.path
      }images/src/images/background_white_3.png`,
      "sfeir-bg-white-4": `${
        this.path
      }images/src/images/background_white_4.png`,
      "sfeir-bg-white-5": `${
        this.path
      }images/src/images/background_white_5.png`,
      "sfeir-bg-white-6": `${
        this.path
      }images/src/images/background_white_6.png`,
      "sfeir-bg-white-7": `${
        this.path
      }images/src/images/background_white_7.png`,
    ...
    for (let genericSlide of genericsSlides) {
      ...
      genericSlide.setAttribute(
        "data-background",
        `${this.path}images/src/images/background_white_1.png`
      );
    }
  ...
  _manageFirstSlide() {
    ...
    for (let firstSlideSection of firstSlides) {
      ...
      imgLogo.style["background-image"] = `url(${
        this.path
      }images/src/images/logo_empty.png)`;
  ...
  _manageSpecificsColumnsSlides() {
    const twoColSlides = [
      ...document.querySelectorAll(".reveal .slides section.two-column-layout")
    ];
