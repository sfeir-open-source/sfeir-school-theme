...
4. **High Code Coverage:** Aim for >80% code coverage for all TypeScript and JavaScript modules (Not applicable for CSS/SCSS)
...
6. **Verify Coverage:** Run coverage reports using the project's chosen tools.
   Target: >80% coverage for new TypeScript/JavaScript code. The specific tools and commands will vary by language and framework.
...
- [ ] All tests pass
- [ ] Code coverage meets requirements (>80% for TypeScript/JavaScript)
...
3. Code coverage meets project requirements (>80% for TS/JS)
